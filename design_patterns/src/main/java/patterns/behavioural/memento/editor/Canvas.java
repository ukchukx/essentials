...
import patterns.behavioural.memento.commands.ColourCommand;
import patterns.behavioural.memento.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (target != null) {
                    editor.execute(new ColourCommand(editor, new Color((int) (Math.random() * 0x1000000))));
                    repaint();
                }
            }
        };
